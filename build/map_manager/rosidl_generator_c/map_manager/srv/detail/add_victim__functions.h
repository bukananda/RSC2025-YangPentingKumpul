...
#ifndef MAP_MANAGER__SRV__DETAIL__ADD_VICTIM__FUNCTIONS_H_
#define MAP_MANAGER__SRV__DETAIL__ADD_VICTIM__FUNCTIONS_H_
...
/// Initialize srv/AddVictim message.
/**
...
/// Finalize srv/AddVictim message.
/**
...
/// Create srv/AddVictim message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * map_manager__srv__AddVictim_Request__init().
...
/// Destroy srv/AddVictim message.
/**
 * It calls
 * map_manager__srv__AddVictim_Request__fini()
...
/// Check for srv/AddVictim message equality.
/**
...
/// Initialize array of srv/AddVictim messages.
/**
...
/// Finalize array of srv/AddVictim messages.
/**
 * It calls
 * map_manager__srv__AddVictim_Request__fini()
...
/// Create array of srv/AddVictim messages.
/**
 * It allocates the memory for the array and calls
 * map_manager__srv__AddVictim_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AddVictim messages.
/**
 * It calls
 * map_manager__srv__AddVictim_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AddVictim message array equality.
/**
...
/// Copy an array of srv/AddVictim messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * map_manager__srv__AddVictim_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_map_manager
...
/**
 * It calls
 * map_manager__srv__AddVictim_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_map_manager
...
/**
 * It allocates the memory for the array and calls
 * map_manager__srv__AddVictim_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_map_manager
...
/**
 * It calls
 * map_manager__srv__AddVictim_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MAP_MANAGER__SRV__DETAIL__ADD_VICTIM__FUNCTIONS_H_
